...
The repository root [`README.md`](../README.md) is the entry point. It answers "what is Spicy-Tofu and how does it work?" and links into the pages catalogued here.
...
| [domain-layer.md](./technical/domain-layer.md) | Domain models, the aggregate root base, locator attributes, the execution step record, and the configuration option classes. | 2026-09-25 |
| [configuration.md](./technical/configuration.md) | Configuration sections, which platform binds what, environment variable overlay, and binding gaps. | 2026-09-25 |
...
| [logging.md](./technical/logging.md) | The execution-oriented `ILogger` facade, `LogEntry`/`LogKind`, `LocatorCandidate`, the `IPrintStrategy` seam, and CI/Interactive rendering. | 2026-09-25 |
...
| [setup-and-commands.md](./technical/setup-and-commands.md) | Prerequisites, build/test/format commands, the Playwright browser install step, Appium and mobile device setup, and configuration sources. | 2026-09-25 |
