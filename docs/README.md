...
| [dependency-injection.md](./technical/dependency-injection.md) | Composition roots, DI extensions, and how `AddWebAutomation` and `AddMobileAutomation` gate the platform registrations. | 2026-09-20 |
